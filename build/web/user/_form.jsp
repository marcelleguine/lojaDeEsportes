<form id="form-usuario" class="form-horizontal" method="post" action="/lojaDeEsportes/UserServlet">
  ...
  <div id="usuario-box-cpf" class="control-group">
    ...
    <div class="controls">
      <input type="number" id="cpf" name="cpf" placeholder="___ . ___ . ___ - __"> <!-- criar máscara -->
   ...
   <div id="usuario-box-salario" class="control-group">
    ...
    <div class="controls">
      <input type="text" id="salario" name="salario" placeholder="R$"> <!-- criar máscara -->
  ...
  <div id="usuario-box-data" class="control-group">
    ...
    <div class="controls">
      <input type="text" id="data-nascimento" name="data-nascimento" placeholder="__/__/__"> <!-- criar máscara -->
  ...
  <div id="usuario-box-email" class="control-group">
    ...
    <div class="controls">
      <input type="text" id="email" name="email" placeholder="email@email.com"> <!-- criar máscara -->
